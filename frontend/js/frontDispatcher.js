...
// Mostrar/ocultar campos de login según el rol (para index.html)
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Verificación de acceso para dashboards
    const currentPage = window.location.pathname.split('/').pop();
    if (currentPage === 'adminDashboard.html' && (!localStorage.getItem('token') || localStorage.getItem('rol') !== 'ADMIN')) {
        window.location.href = 'index.html';
    }
    if (currentPage === 'artistDashboard.html' && (!localStorage.getItem('token') || localStorage.getItem('rol') !== 'ARTIST')) {
        window.location.href = 'index.html';
    }
});

// Manejar el login (para index.html)
...
// Manejar el registro (para register.html)
...
// Función de logout (para adminDashboard.html y artistDashboard.html)
function logout() {
